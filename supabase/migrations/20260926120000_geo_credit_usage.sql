...
-- and directions included. Optimize looks up opening hours and checks the
-- routes of a whole trip at once, so it reserves what it is about to spend
-- here first, and skips those once the day's share is used. Everything else
-- keeps the rest.
--
