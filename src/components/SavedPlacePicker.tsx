    ...
    <div className="space-y-2 rounded-xl border border-border p-3">
      <div className="flex items-start justify-between gap-2">
        ...
        <button
          type="button"
          onClick={onClose}
          className="shrink-0 rounded-lg border border-border px-2.5 py-1 text-[11px]"
        >
          Close
        </button>
      </div>

      {vault.loading && <p className="text-[12px] text-muted-foreground">Fetching your places…</p>}
