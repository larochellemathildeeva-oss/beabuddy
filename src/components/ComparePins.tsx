          ...
          {result && (
            <div className="rise space-y-2 rounded-2xl border border-border bg-elevated p-3">
              ...
              <button
                ...
                className="w-full rounded-xl border border-primary px-4 py-2 text-[14.5px] font-semibold text-primary"
              >
      ...
      {result && sideBySide && (
        ...
        >
          ...
          <div className="flex-1 overflow-auto p-4">
            ...
            <p className="mt-4 text-[13px] text-muted-foreground">{result.tip}</p>
