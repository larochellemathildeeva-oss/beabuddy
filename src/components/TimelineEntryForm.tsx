...
export function TimelineEntryForm({
  ...
  const chip = (active: boolean, set: boolean) =>
    `flex items-center gap-1 rounded-full border px-2.5 py-1.5 text-[13px] ${
      active
  ...
  return (
    <div className="space-y-2.5 rounded-xl bg-elevated p-3">
      ...
      {placeAddress && (
        <div className="flex items-start justify-between gap-2 rounded-xl border border-primary/40 bg-elevated px-3 py-2">
          <div className="min-w-0">
            ...
            {place.note && (
              <p aria-live="polite" className="mt-0.5 text-[12px] text-muted-foreground">
                {place.note}
      ...
      {panel === "kind" && (
        <div className="flex flex-wrap gap-1.5 rounded-xl bg-elevated p-2.5">
      ...
      {panel === "day" && (
        <div className="space-y-2 rounded-xl bg-elevated p-2.5">
          {days.length > 1 && (
      ...
      {added > 0 && !justAdded && !error && (
        <p aria-live="polite" className="text-[12px] text-primary">
