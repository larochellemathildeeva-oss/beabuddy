        ...
        {empty && (
          <section className="rise card-soft p-4">
            ...
            <p className="mt-1 text-[13px] text-muted-foreground">
              Import photos to map the cities you've been, or save your first recommendation.
            </p>
            <div className="mt-3 flex gap-2">
              ...
              >
                {user ? "Import photos" : "Create an account"}
              </Link>
              <Link
                to="/recommendations"
              ...
              {recentCities.map((c) => (
                ...
                >
                  ...
                  <p className="text-[11px] text-muted-foreground">
                    {c.last ? new Date(c.last).toLocaleDateString(undefined, { month: "long", year: "numeric" }) : ""}
                  </p>
                </Link>
              ))}
            </div>
