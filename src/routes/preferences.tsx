...
function Chip({
  ...
  return (
    ...
    >
      ...
      {hint && (
        <span
          className={`block text-[12.5px] ${active ? "text-primary-foreground/80" : "text-muted-foreground"}`}
        >
          {hint}
        </span>
      )}
  ...
  return (
    <AppShell eyebrow="Béa's brain" title="Travel preferences">
      <div className="space-y-4">
        ...
        {!loading && !user && (
          <div className="card-soft p-4 text-[15px]">
        ...
        <section data-guide="pref-style" className="card-soft p-4">
          ...
          <p className="mt-1 text-[13.5px] text-muted-foreground">Pick as many as feel true.</p>
        ...
        <section data-guide="pref-countries" className="card-soft p-4">
            ...
            <div className="mt-3 flex flex-wrap gap-2">
              {prefs.preferred_countries.map((c) => (
                <button
                  ...
                  className="rounded-full border border-primary bg-primary px-3 py-1.5 text-[13.5px] text-primary-foreground"
                >
                  {c} ✕
                </button>
              ))}
          ...
          <div className="mt-3 flex gap-2">
            <input
              ...
              className="flex-1 rounded-xl border border-border bg-card px-3 py-2.5 text-[15px] outline-none focus:border-primary"
            />
            <button
              onClick={addCountry}
            ...
            {suggestedCountries
              ...
              .map((c) => (
                <button
                  ...
                  className="rounded-full border border-border bg-card px-3 py-1.5 text-[13.5px] text-muted-foreground"
                >
                  + {c}
                </button>
              ))}
        ...
        <section data-guide="pref-interests" className="card-soft p-4">
          ...
          <div className="mt-3 space-y-4">
            {preferenceGroups.map((group) => (
              <div key={group.title}>
                <p className="text-[15px] font-medium">{group.title}</p>
        ...
        <section data-guide="pref-rules" className="card-soft p-4">
          ...
          <textarea
            ...
            className="mt-3 w-full rounded-xl border border-border bg-card px-3 py-2.5 text-[15px] outline-none focus:border-primary"
          />
          <textarea
            ...
            className="mt-2 w-full rounded-xl border border-border bg-card px-3 py-2.5 text-[15px] outline-none focus:border-primary"
          />
        </section>

        <p className="pb-2 text-center text-[13.5px] text-muted-foreground">
