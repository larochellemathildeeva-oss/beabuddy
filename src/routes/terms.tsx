    ...
    <AppShell publicPage eyebrow="Béa" title="Terms of Service">
      ...
      <Section title="2. Acceptance and eligibility">
        <p>
          ...
          confirm you are authorised to accept these terms for it. You must be at least 16 years old
      ...
      <Section title="5. Your content">
        <p>
          ...
          host, store, transmit, back up and display that content, and to process it through the
          service providers described in the Privacy Policy, strictly so the app can function for
          you. This licence ends when you delete the content or your account, apart from copies
          retained briefly in routine backups.
        </p>
        <p>
      ...
      <Section title="6. Acceptable use">
        ...
        <ul className="list-disc space-y-1.5 pl-5">
          ...
          <li>
            probe, attack, scrape or attempt to bypass the app's security or other members' privacy;
          </li>
          <li>
            use the app to store another person's sensitive documents without their permission;
          </li>
          <li>misuse location features to track anyone without their knowledge and consent;</li>
          <li>
            overload, disrupt or interfere with the app, its networks or other members' use of it;
          </li>
      ...
      <Section title="17. Limitation of liability">
        <p>
          ...
          profits, trips, bookings, opportunities or goodwill, arising from or related to your use
          of the app — including reliance on AI suggestions, directions, exchange rates, or the
          unavailability of offline downloads.
        </p>
        <p>
          Where liability cannot be excluded, our total aggregate liability to you for any claim is
          limited to the amount you paid us for the app in the twelve months before the claim (or,
          if you paid nothing, to CAD $50). Nothing in these terms limits liability for fraud, death
