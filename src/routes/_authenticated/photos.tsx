                    ...
                    <div className="grid grid-cols-3 gap-2">
                      {list.map((r) => (
                        <button
                          ...
                          onClick={() => remove(r)}
                          title="Tap to remove"
                          className="flex aspect-square items-center justify-center overflow-hidden rounded-xl border border-border bg-muted p-1 text-center text-[11.5px] text-muted-foreground"
                        >
                          {urls[r.id] ? (
                            <img
                              src={urls[r.id]}
